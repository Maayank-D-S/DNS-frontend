    ...
    <section className="py-16 overflow-hidden bg-black text-white">
      ...
      <div className="relative w-screen px-[7vw] md:px-[10vw] overflow-visible">
        ...
        >
          {/* Slide #1 */}
          <div
            className="flex-shrink-0 flex bg-black rounded-xl shadow-[0_0_40px_rgba(255,255,255,0.5)] overflow-hidden"
            style={{
          ...
          {/* Slide #2 */}
          <div
            className="flex-shrink-0 flex bg-[#26232C] rounded-xl shadow-[0_0_40px_rgba(255,255,255,0.5)] overflow-hidden"
            style={{
              width: isMobile ? `${SLIDE_W_MOB}vw` : `${SLIDE_W_DESK}vw`,
              height: isMobile ? `${SLIDE_H_MOB}vw` : `${SLIDE_H_DESK}vh`
            }}
          ...
          {/* Slide #4 */}
          <div
            className="flex-shrink-0 flex bg-white rounded-xl shadow-[0_0_40px_rgba(255,255,255,0.5)] overflow-hidden"
            style={{
              width: isMobile ? `${SLIDE_W_MOB}vw` : `${SLIDE_W_DESK}vw`,
              height: isMobile ? `${SLIDE_H_MOB}vw` : `${SLIDE_H_DESK}vh`
            }}
          ...
          {/* Slide #5 */}
          <div
            className="flex-shrink-0 flex bg-[#E6DAFF] rounded-xl shadow-[0_0_40px_rgba(255,255,255,0.5)] overflow-hidden"
            style={{
              width: isMobile ? `${SLIDE_W_MOB}vw` : `${SLIDE_W_DESK}vw`,
              height: isMobile ? `${SLIDE_H_MOB}vw` : `${SLIDE_H_DESK}vh`
            }}
