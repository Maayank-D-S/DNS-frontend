...
/></a>
      ...
      <div
        className={`
          fixed top-0 left-0 right-0 bottom-0 bg-black/90 text-white z-30
      ...
      >
        ...
        <div className="divide-y divide-white/20 ml-3">
  <Link
    to="/story"
  ...
  <div className="py-4">
    ...
    {showProducts && (
      <div className="mt-4 pl-4 space-y-4">
        ...
        <div>
          <button
            onClick={() => setShowCSite(prev => !prev)}
        ...
        <div>
          <button
            onClick={() => setShowUnBroker(prev => !prev)}
            className="w-full flex justify-between items-center"
          >
            <span>UnBroker</span>
            <ChevronDown className="w-3 h-3" />
        ...
        <div>
          <button
            onClick={() => setShowCivil(prev => !prev)}
            className="w-full flex justify-between items-center"
          >
            <span>Civil Consultancy Services</span>
            <ChevronDown className="w-3 h-3" />
          </button>
          {showCivil && (
            <ul className="mt-2 pl-4 space-y-1 text-sm text-white/80">
  ...
  >
    Blog
      ...
      <div
        className={`
          ...
          ${showProjects ? "translate-y-0 opacity-100 pointer-events-auto" : "-translate-y-full opacity-0 pointer-events-none"}
        `}
      >
        <button
    ...
    <div>
      ...
      <ul className="space-y-2 text-white/90">
        ...
        <li><span className="block font-medium">Channel Partner Management</span></li>
        <li><span className="block font-medium">Digital Sales Tools</span></li>
    ...
    <div>
      <h3 className="font-bold text-lg mb-4">Civil Consultancy Services</h3>
      <ul className="space-y-2 text-white/90">
        <li>Building Information Modeling (BIM)</li>
        <li>Feasibility research</li>
        <li>Geotechnical engineering</li>
        ...
        <div className="max-w-4xl mx-auto pt-40 px-6">
          ...
          <div className="mt-10">
            ...
            <div className="flex gap-6 text-sm text-gray-300 flex-wrap">
              ...
              <span className="cursor-pointer hover:text-yellow-400">Careers</span>
              <span className="cursor-pointer hover:text-yellow-400">Products</span>
              <span className="cursor-pointer hover:text-yellow-400">Investor Relations</span>
              <span className="cursor-pointer hover:text-yellow-400">Blogs</span>
            </div>
          </div>
        </div>
        <button
