...
const blogs = [
  { 
    id: "legal-steps-to-buy-or-sell-property-in-noida",
    title: "Legal Steps to Buy or Sell Property in Noida",
    image: "/blog/1.jpg",
    heading:
      "Buying or selling property in Noida? This guide breaks down the legal steps—title checks, sale agreements, stamp duty, registration, and mutation. Ensure a smooth, risk-free transaction by verifying documents, settling dues, and updating ownership with authorities. A must-read for anyone navigating Noida’s real estate market.",
    content: [
      {
        heading: "Verifying the Property Before Sale",
        image: "/blog6/1.png",
        copy:
          "Before any deal, ensure the property has a clear title, no pending loans, and is approved by Noida Authority. Check original sale deed, encumbrance certificate, tax receipts, and builder approvals to avoid legal hurdles later.",
      },
      {
...
society to confirm there are no outstanding payments.`,
      },
      {
        ...
        image: "/blog/3.jpg",
        copy:
          "Property transfer becomes official after paying stamp duty and registering the sale deed at the Sub-Registrar’s office. Both parties must be present with valid documents and witnesses. Always cross-check the deed for accuracy before signing.",
      },
      {
        heading: "Post-Sale Handover and Mutation",
        image: "/blog/4.jpg",
        copy:
          "After registration, the buyer must update property records with the Noida Authority and inform the builder or RWA. This ensures future utility bills, taxes, and legal responsibilities reflect the new owner’s name correctly.",
      },
      {
        heading: "Simplify Every Step with UnBroker",
        image: "/blog/last.png",
        copy:
          "UnBroker is your AI-powered real estate guide. We help you decode legal documents, answer queries, and verify properties—so you make confident, informed decisions without relying on middlemen. Experience smarter homebuying with UnBroker.",
      },
    ],
  },
  {
    id: "legal-steps-to-buy-or-sell-property-in-pune",
    title: "Legal Steps to Buy or Sell Property in Pune",
    image: "/blog/2.jpg",
    heading:
      "Planning to buy or sell property in Pune? This guide walks you through all legal steps—from verifying title documents and drafting the sale agreement to registering the deed and updating municipal records. Avoid legal issues and ensure a seamless transfer by following these essential steps for a secure transaction.",
    content: [
      {
        heading: "Verifying the Property Before Sale",
        image: "/blog/1.jpg",
        copy:
          "Begin by checking the property's title deed, latest 7/12 extract, encumbrance certificate, and approved layout plans. Confirm the seller has full rights and no legal or financial disputes are attached to the property or land.",
      },
      {
        heading: "Drafting the Agreement to Sell",
        image: "/blog/2.jpg",
...
reflects accurate ownership and payment details.`,
      },
      {
        ...
        image: "/blog/4.jpg",
        copy:
          "After registration, the buyer must apply for mutation at the Pune Municipal Corporation or revenue office. This updates tax and property records, ensuring all future correspondence and bills are directed to the new owner.",
      },
      {
        heading: "Simplify Every Step with UnBroker",
        image: "/blog/last.png",
        copy:
          "UnBroker is your AI-powered brokerage assistant, helping you understand legal steps, verify documents, and resolve queries instantly. Say goodbye to confusion and hidden risks—UnBroker ensures your property decisions are smart, safe, and seamless.",
      },
    ],
  },
  {
    id: "legal-steps-to-buy-or-sell-property-in-mumbai",
    title: "Legal Steps to Buy or Sell Property in Mumbai",
    image: "/blog/3.jpg",
    heading:
      "Navigating a property transaction in Mumbai? This guide covers all key legal steps—title verification, drafting a sale agreement, registration, stamp duty, and post-sale mutation. Learn how to avoid risks, ensure due diligence, and secure a smooth transfer of ownership in one of India’s most dynamic real estate markets.",
    content: [
      {
        heading: "Verifying the Property Before Sale",
        image: "/blog/1.jpg",
        copy:
          "Start by verifying the property's title, latest property card, encumbrance certificate, and society share certificate. For flats, ensure the building has an Occupancy Certificate and the seller has paid all municipal and society dues.",
      },
      {
        heading: "Drafting the Agreement to Sell",
        image: "/blog/2.jpg",
...
redevelopment or tenancy issues in the building.`,
      },
      {
        ...
        image: "/blog/3.jpg",
        copy:
          "Registration is done at the Mumbai Sub-Registrar’s office after paying stamp duty (typically 5%). Both parties must be present with identity proofs. Ensure the sale deed has correct flat details, payment confirmation, and seller disclosures.",
      },
      {
        heading: "Post-Sale Handover and Mutation",
        image: "/blog/4.jpg",
        copy:
          "Post-registration, apply for mutation with BMC or MHADA (if applicable) to transfer property records. Update the society records with the buyer’s name to ensure correct billing and legal recognition in future transactions.",
      },
      {
        heading: "Simplify Every Step with UnBroker",
        image: "/blog/last.png",
        copy:
          "UnBroker uses AI to guide you through legal formalities, verify documents, and answer real estate queries instantly. It’s your digital co-pilot for stress-free, smarter home buying or selling in Mumbai—minus the brokerage chaos.",
      },
    ],
  },
  {
    id: "legal-steps-to-buy-or-sell-property-in-dubai",
    title: "Legal Steps to Buy or Sell Property in Dubai",
    image: "/blog/4.jpg",
    heading:
      "Buying or selling property in Dubai? This guide simplifies the legal process—title checks via DLD, MoU signing, obtaining a developer NOC, and completing transfer at the trustee office. Learn how to ensure a secure, compliant transaction and seamless handover in one of the world’s most regulated real estate markets.",
    content: [
      {
        heading: "Verifying the Property Before Sale",
        image: "/blog/1.jpg",
...
are transparent and legally vetted.`,
      },
      {
        ...
        image: "/blog/3.jpg",
        copy:
          "The seller must get a No Objection Certificate (NOC) from the developer to proceed with the transfer. The final transaction is completed at the DLD trustee office, where the buyer pays, and the new title deed is issued.",
      },
      {
        heading: "Final Updates and Handover",
        image: "/blog/4.jpg",
        copy:
          "After transfer, utility accounts, service contracts, and community records must be updated in the buyer's name. It’s essential to inspect the property, collect access cards, and ensure all prior dues are fully settled before moving in.",
      },
      {
        heading: "Simplify Every Step with UnBroker",
        image: "/blog/last.png",
...
brokers.`,
  ...
  {
    id: "why-are-property-prices-rising-in-indian-metro-cities",
    title: "Why Are Property Prices Rising in Indian Metro Cities?",
    image: "/blog8/1.jpg",
    heading:
      "Property prices in Indian metros are surging due to post-COVID demand, limited new supply, and infrastructure growth—especially in Delhi NCR. A shift toward branded developers and a spike in NRI and investor interest are further intensifying the market. This blog decodes the forces behind the real estate upswing.",
    content: [
      {
...
created a gap, inflating prices across premium and mid-segment housing.`,
      },
      {
        ...
        image: "/blog8/3.jpg",
        copy:
          "Delhi NCR has seen large-scale infrastructure investments—like the Delhi-Mumbai Expressway, Dwarka Expressway, and Noida Airport—making surrounding areas more attractive for end users and investors. This has fueled rapid price hikes in micro-markets like Gurugram, Noida, and Ghaziabad.",
      },
      {
        heading: "Shift Towards Branded Developers",
        image: "/blog8/4.jpg",
        copy:
          "With rising buyer awareness, demand has shifted to branded and RERA-compliant developers who offer timely delivery and better quality. This has concentrated demand in fewer, more credible projects—driving up prices in those communities.",
      },
      {
...
data-backed property decisions.`,
  ...
  },
  {
    ...
    image: "/blog1/1.png",
    heading:
      "Building Information Modeling (BIM) is rapidly becoming the standard for design, planning, and execution of construction projects in India.",
    content: [
      {
  ...
  },
  {
    ...
    image: "/blog2/1.png",
    heading:
      "Before a project takes physical form, it must be tested on paper for economic, technical, environmental, and regulatory feasibility.",
    content: [
      {
      ...
      },
      {
        ...
        image: "/abc.png",
        copy:
          "Site and location evaluation, Regulatory and development constraint mapping, Preliminary cost-benefit analysis, Infrastructure and utility availability review, Environmental and risk considerations, Market research (demand–supply, pricing, trends), Feasibility reports for internal or official use",
      },
    ],
  },
  {
...
green building rating systems such as LEED or local equivalents.`,
  ...
  },
  {
    ...
    image: "/blog5/1.png",
    heading:
      "We provide integrated MEP design solutions that ensure functionality, safety, efficiency, and seamless coordination across building systems.",
    content: [
      {
        heading: "MEP Design",
        image: "/blog5/1.png",
...
management. These systems must be planned in tandem to avoid conflicts (for example,coordinating ductwork and pipe routes with structural elements) and to meet building codes and
